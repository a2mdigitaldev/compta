package com.comptamaroc.core.dto;
...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> success(T data) {
        return new ApiResponse<>(true, "Success", data, (String) null);
    }
    ...
    public static <T> ApiResponse<T> success(String message) {
        return new ApiResponse<>(true, message, null, (String) null);
    }
    ...
    public static <T> ApiResponse<T> error(String message, T data) {
        return new ApiResponse<>(false, message, data, (String) null);
    }
